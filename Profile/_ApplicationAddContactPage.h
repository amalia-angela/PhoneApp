...
#ifndef _ApplicationAddContactPage_H
#define _ApplicationAddContactPage_H
...
/* Deklaration of class : 'Application::AddContactPage' */
EW_DEFINE_FIELDS( ApplicationAddContactPage, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationAddContactPage )

/* Virtual Method Table (VMT) for the class : 'Application::AddContactPage' */
EW_DEFINE_METHODS( ApplicationAddContactPage, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationAddContactPage _this, XPoint 
    aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationAddContactPage _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationAddContactPage )
...
#endif /* _ApplicationAddContactPage_H */
