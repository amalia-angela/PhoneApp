...
#ifndef _ApplicationMessagesApp_H
#define _ApplicationMessagesApp_H
...
/* Forward declaration of the class Application::ContactsListInsideMessages */
#ifndef _ApplicationContactsListInsideMessages_
  EW_DECLARE_CLASS( ApplicationContactsListInsideMessages )
#define _ApplicationContactsListInsideMessages_
#endif
...
/* Deklaration of class : 'Application::MessagesApp' */
EW_DEFINE_FIELDS( ApplicationMessagesApp, CoreGroup )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( VerticalList,    CoreVerticalList )
  EW_OBJECT  ( SearchExt,       ComponentsInputBtnEtxt )
  EW_OBJECT  ( TitleTxt,        ViewsText )
  EW_OBJECT  ( createBtn,       ComponentsSButton25x25 )
  EW_OBJECT  ( editBtn,         ComponentsTextButton )
  EW_OBJECT  ( deleteBtn,       ComponentsTextButton )
  EW_OBJECT  ( SelectedContacts, DeviceContactsList )
  EW_OBJECT  ( SlideTouchHandler, CoreSlideTouchHandler )
  EW_OBJECT  ( ContactsInsideSearch, ApplicationContactsInsideSearch )
  EW_VARIABLE( addNewChat,      ApplicationContactsListInsideMessages )
  EW_VARIABLE( chat,            ApplicationChatPage )
  EW_PROPERTY( EditMode,        XBool )
EW_END_OF_FIELDS( ApplicationMessagesApp )

/* Virtual Method Table (VMT) for the class : 'Application::MessagesApp' */
EW_DEFINE_METHODS( ApplicationMessagesApp, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationMessagesApp )
...
#endif /* _ApplicationMessagesApp_H */
