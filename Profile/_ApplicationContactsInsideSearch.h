...
#ifndef _ApplicationContactsInsideSearch_H
#define _ApplicationContactsInsideSearch_H
...
/* Forward declaration of the class Application::ContactsInsideSearch */
#ifndef _ApplicationContactsInsideSearch_
  EW_DECLARE_CLASS( ApplicationContactsInsideSearch )
#define _ApplicationContactsInsideSearch_
#endif
...
/* Deklaration of class : 'Application::ContactsInsideSearch' */
EW_DEFINE_FIELDS( ApplicationContactsInsideSearch, CoreGroup )
  ...
  EW_PROPERTY( OnSelectedContact, XSlot )
EW_END_OF_FIELDS( ApplicationContactsInsideSearch )

/* Virtual Method Table (VMT) for the class : 'Application::ContactsInsideSearch' */
EW_DEFINE_METHODS( ApplicationContactsInsideSearch, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationContactsInsideSearch )
...
#endif /* _ApplicationContactsInsideSearch_H */
