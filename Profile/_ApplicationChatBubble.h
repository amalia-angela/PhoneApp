...
#ifndef _ApplicationChatBubble_H
#define _ApplicationChatBubble_H
...
/* Forward declaration of the class Application::ChatBubble */
#ifndef _ApplicationChatBubble_
  EW_DECLARE_CLASS( ApplicationChatBubble )
#define _ApplicationChatBubble_
#endif
...
/* Deklaration of class : 'Application::ChatBubble' */
EW_DEFINE_FIELDS( ApplicationChatBubble, CoreGroup )
  EW_OBJECT  ( Frame,           ViewsFrame )
  EW_OBJECT  ( Text,            ViewsText )
  EW_PROPERTY( Message,         XString )
  EW_PROPERTY( BubbleColor,     XColor )
  EW_PROPERTY( MessageColor,    XColor )
  EW_PROPERTY( LeftAligned,     XBool )
EW_END_OF_FIELDS( ApplicationChatBubble )

/* Virtual Method Table (VMT) for the class : 'Application::ChatBubble' */
EW_DEFINE_METHODS( ApplicationChatBubble, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ApplicationChatBubble _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationChatBubble )
...
#endif /* _ApplicationChatBubble_H */
