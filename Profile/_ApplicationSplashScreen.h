...
#ifndef _ApplicationSplashScreen_H
#define _ApplicationSplashScreen_H
...
/* Deklaration of class : 'Application::SplashScreen' */
EW_DEFINE_FIELDS( ApplicationSplashScreen, CoreGroup )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( Image,           ViewsImage )
  EW_OBJECT  ( SimpleTouchHandler, CoreSimpleTouchHandler )
  EW_VARIABLE( OnStart,         XSlot )
EW_END_OF_FIELDS( ApplicationSplashScreen )

/* Virtual Method Table (VMT) for the class : 'Application::SplashScreen' */
EW_DEFINE_METHODS( ApplicationSplashScreen, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationSplashScreen )
...
#endif /* _ApplicationSplashScreen_H */
