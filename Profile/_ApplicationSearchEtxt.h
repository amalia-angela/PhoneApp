...
#ifndef _ApplicationSearchEtxt_H
#define _ApplicationSearchEtxt_H
...
/* Forward declaration of the class Application::SearchEtxt */
#ifndef _ApplicationSearchEtxt_
  EW_DECLARE_CLASS( ApplicationSearchEtxt )
#define _ApplicationSearchEtxt_
#endif
...
EW_DEFINE_FIELDS( ApplicationSearchEtxt, TemplatesTextEditor )
...
EW_END_OF_FIELDS( ApplicationSearchEtxt )

/* Virtual Method Table (VMT) for the class : 'Application::SearchEtxt' */
EW_DEFINE_METHODS( ApplicationSearchEtxt, TemplatesTextEditor )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ApplicationSearchEtxt _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationSearchEtxt )
...
#endif /* _ApplicationSearchEtxt_H */
