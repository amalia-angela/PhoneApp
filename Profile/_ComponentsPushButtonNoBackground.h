...
#ifndef _ComponentsPushButtonNoBackground_H
#define _ComponentsPushButtonNoBackground_H
...
/* Forward declaration of the class Components::PushButtonNoBackground */
#ifndef _ComponentsPushButtonNoBackground_
  EW_DECLARE_CLASS( ComponentsPushButtonNoBackground )
#define _ComponentsPushButtonNoBackground_
#endif
...
EW_DEFINE_FIELDS( ComponentsPushButtonNoBackground, TemplatesPushButton )
...
EW_END_OF_FIELDS( ComponentsPushButtonNoBackground )

/* Virtual Method Table (VMT) for the class : 'Components::PushButtonNoBackground' */
EW_DEFINE_METHODS( ComponentsPushButtonNoBackground, TemplatesPushButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ComponentsPushButtonNoBackground _this, 
    XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsPushButtonNoBackground )
...
#endif /* _ComponentsPushButtonNoBackground_H */
