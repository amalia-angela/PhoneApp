...
#ifndef _ApplicationContactsList1_H
#define _ApplicationContactsList1_H
...
/* Deklaration of class : 'Application::ContactsList1' */
EW_DEFINE_FIELDS( ApplicationContactsList1, ApplicationContactsList )
EW_END_OF_FIELDS( ApplicationContactsList1 )

/* Virtual Method Table (VMT) for the class : 'Application::ContactsList1' */
EW_DEFINE_METHODS( ApplicationContactsList1, ApplicationContactsList )
  ...
  EW_METHOD( onContactActivated, void )( ApplicationContactsList _this, XObject 
    sender )
EW_END_OF_METHODS( ApplicationContactsList1 )

#ifdef __cplusplus
  }
#endif

#endif /* _ApplicationContactsList1_H */
