...
#ifndef _ApplicationDetailsInsideCall_H
#define _ApplicationDetailsInsideCall_H
...
/* Forward declaration of the class Application::DetailsInsideCall */
#ifndef _ApplicationDetailsInsideCall_
  EW_DECLARE_CLASS( ApplicationDetailsInsideCall )
#define _ApplicationDetailsInsideCall_
#endif
...
/* Deklaration of class : 'Application::DetailsInsideCall' */
EW_DEFINE_FIELDS( ApplicationDetailsInsideCall, ApplicationContactDetailsPage )
EW_END_OF_FIELDS( ApplicationDetailsInsideCall )

/* Virtual Method Table (VMT) for the class : 'Application::DetailsInsideCall' */
EW_DEFINE_METHODS( ApplicationDetailsInsideCall, ApplicationContactDetailsPage )
...
#endif /* _ApplicationDetailsInsideCall_H */
