...
#ifndef _ComponentsPushButtonDelete_H
#define _ComponentsPushButtonDelete_H
...
/* Forward declaration of the class Components::PushButtonDelete */
#ifndef _ComponentsPushButtonDelete_
  EW_DECLARE_CLASS( ComponentsPushButtonDelete )
#define _ComponentsPushButtonDelete_
#endif
...
EW_DEFINE_FIELDS( ComponentsPushButtonDelete, TemplatesPushButton )
...
EW_END_OF_FIELDS( ComponentsPushButtonDelete )

/* Virtual Method Table (VMT) for the class : 'Components::PushButtonDelete' */
EW_DEFINE_METHODS( ComponentsPushButtonDelete, TemplatesPushButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ComponentsPushButtonDelete _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsPushButtonDelete )
...
#endif /* _ComponentsPushButtonDelete_H */
