...
#ifndef _ApplicationContactsListInsideMessages_H
#define _ApplicationContactsListInsideMessages_H
...
/* Deklaration of class : 'Application::ContactsListInsideMessages' */
EW_DEFINE_FIELDS( ApplicationContactsListInsideMessages, ApplicationContactsList )
EW_END_OF_FIELDS( ApplicationContactsListInsideMessages )

/* Virtual Method Table (VMT) for the class : 'Application::ContactsListInsideMessages' */
EW_DEFINE_METHODS( ApplicationContactsListInsideMessages, ApplicationContactsList )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( onContactPressed,  void )( ApplicationContactsListInsideMessages _this, 
    XObject sender )
EW_END_OF_METHODS( ApplicationContactsListInsideMessages )
...
#endif /* _ApplicationContactsListInsideMessages_H */
