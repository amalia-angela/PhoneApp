...
#ifndef _TemplatesToggleButton_H
#define _TemplatesToggleButton_H
...
/* Forward declaration of the class Templates::ToggleButton */
#ifndef _TemplatesToggleButton_
  EW_DECLARE_CLASS( TemplatesToggleButton )
#define _TemplatesToggleButton_
#endif


/* Deklaration of class : 'Templates::ToggleButton' */
EW_DEFINE_FIELDS( TemplatesToggleButton, CoreGroup )
EW_END_OF_FIELDS( TemplatesToggleButton )

/* Virtual Method Table (VMT) for the class : 'Templates::ToggleButton' */
EW_DEFINE_METHODS( TemplatesToggleButton, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( TemplatesToggleButton )

#ifdef __cplusplus
  }
#endif

#endif /* _TemplatesToggleButton_H */
