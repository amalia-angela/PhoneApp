...
#ifndef _ApplicationContactsList_H
#define _ApplicationContactsList_H
...
EW_DEFINE_METHODS( ApplicationContactsList, ApplicationContactsInsideCall )
...
#endif /* _ApplicationContactsList_H */
