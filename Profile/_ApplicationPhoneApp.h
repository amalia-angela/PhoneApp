...
#ifndef _ApplicationPhoneApp_H
#define _ApplicationPhoneApp_H
...
EW_DEFINE_FIELDS( ApplicationPhoneApp, CoreGroup )
  EW_OBJECT  ( Outline,         CoreGroup )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( NavBarButtons,   ComponentsNavBarButton64x40 )
  EW_OBJECT  ( NavBarButtons1,  ComponentsNavBarButton64x40 )
  EW_OBJECT  ( NavBarButtons2,  ComponentsNavBarButton64x40 )
  EW_OBJECT  ( NavBarButtons3,  ComponentsNavBarButton64x40 )
  EW_OBJECT  ( Line,            ViewsLine )
  EW_PROPERTY( SelectedPage,    XInt32 )
EW_END_OF_FIELDS( ApplicationPhoneApp )

/* Virtual Method Table (VMT) for the class : 'Application::PhoneApp' */
EW_DEFINE_METHODS( ApplicationPhoneApp, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationPhoneApp )
