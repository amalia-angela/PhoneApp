...
#ifndef _ApplicationEditPage_H
#define _ApplicationEditPage_H
...
/* Deklaration of class : 'Application::EditPage' */
EW_DEFINE_FIELDS( ApplicationEditPage, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationEditPage )

/* Virtual Method Table (VMT) for the class : 'Application::EditPage' */
EW_DEFINE_METHODS( ApplicationEditPage, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationEditPage _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationEditPage _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationEditPage )
