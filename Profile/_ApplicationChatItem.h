...
#ifndef _ApplicationChatItem_H
#define _ApplicationChatItem_H
...
/* Deklaration of class : 'Application::ChatItem' */
EW_DEFINE_FIELDS( ApplicationChatItem, CoreGroup )
  EW_OBJECT  ( Backgound,       ViewsRectangle )
  EW_OBJECT  ( SimpleTouchHandler, CoreSimpleTouchHandler )
  EW_OBJECT  ( ChatOutline,     ViewsFrame )
  EW_OBJECT  ( Text,            ViewsText )
  EW_OBJECT  ( DeleteBtn,       ComponentsTextButton )
  EW_PROPERTY( Message,         DeviceMessage )
  EW_VARIABLE( OnDelete,        XSlot )
  EW_PROPERTY( BubbleColor,     XColor )
  EW_PROPERTY( MessageColor,    XColor )
  EW_PROPERTY( LeftAligned,     XBool )
EW_END_OF_FIELDS( ApplicationChatItem )

/* Virtual Method Table (VMT) for the class : 'Application::ChatItem' */
EW_DEFINE_METHODS( ApplicationChatItem, CoreGroup )
  ...
  EW_METHOD( UpdateViewState,   void )( ApplicationChatItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationChatItem )
