...
#ifndef _ApplicationCallBase_H
#define _ApplicationCallBase_H
...
/* Forward declaration of the class Application::CallBase */
#ifndef _ApplicationCallBase_
  EW_DECLARE_CLASS( ApplicationCallBase )
#define _ApplicationCallBase_
#endif
...
/* Deklaration of class : 'Application::CallBase' */
EW_DEFINE_FIELDS( ApplicationCallBase, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationCallBase )

/* Virtual Method Table (VMT) for the class : 'Application::CallBase' */
EW_DEFINE_METHODS( ApplicationCallBase, CoreGroup )
...
EW_END_OF_METHODS( ApplicationCallBase )
