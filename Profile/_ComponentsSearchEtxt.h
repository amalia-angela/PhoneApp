...
/* 'C' function for method : 'Components::SearchEtxt.OnGetString()' */
XString ComponentsSearchEtxt_OnGetString( ComponentsSearchEtxt _this );

/* 'C' function for method : 'Components::SearchEtxt.OnSetString()' */
void ComponentsSearchEtxt_OnSetString( ComponentsSearchEtxt _this, XString value );
...
/* 'C' function for method : 'Components::SearchEtxt.OnSetIcon()' */
void ComponentsSearchEtxt_OnSetIcon( ComponentsSearchEtxt _this, XString value );

/* 'C' function for method : 'Components::SearchEtxt.onRelease()' */
void ComponentsSearchEtxt_onRelease( ComponentsSearchEtxt _this, XObject sender );
