...
#ifndef _ApplicationContactHistory_H
#define _ApplicationContactHistory_H
...
EW_DEFINE_METHODS( ApplicationContactHistory, ApplicationContact )
...
#endif /* _ApplicationContactHistory_H */
