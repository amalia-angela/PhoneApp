...
#ifndef _ApplicationPushButtonMediumTrans_H
#define _ApplicationPushButtonMediumTrans_H
...
/* Forward declaration of the class Application::PushButtonMediumTrans */
#ifndef _ApplicationPushButtonMediumTrans_
  EW_DECLARE_CLASS( ApplicationPushButtonMediumTrans )
#define _ApplicationPushButtonMediumTrans_
#endif
...
EW_DEFINE_FIELDS( ApplicationPushButtonMediumTrans, TemplatesPushButton )
...
EW_END_OF_FIELDS( ApplicationPushButtonMediumTrans )

/* Virtual Method Table (VMT) for the class : 'Application::PushButtonMediumTrans' */
EW_DEFINE_METHODS( ApplicationPushButtonMediumTrans, TemplatesPushButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ApplicationPushButtonMediumTrans _this, 
    XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationPushButtonMediumTrans )
...
#endif /* _ApplicationPushButtonMediumTrans_H */
