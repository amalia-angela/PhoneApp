...
#ifndef _ApplicationContactsAppInsideCall_H
#define _ApplicationContactsAppInsideCall_H
...
/* Deklaration of class : 'Application::ContactsAppInsideCall' */
EW_DEFINE_FIELDS( ApplicationContactsAppInsideCall, ApplicationContactsApp )
  EW_PROPERTY( OnCancel,        XSlot )
  EW_OBJECT  ( TextButton,      ComponentsTextButton )
EW_END_OF_FIELDS( ApplicationContactsAppInsideCall )

/* Virtual Method Table (VMT) for the class : 'Application::ContactsAppInsideCall' */
EW_DEFINE_METHODS( ApplicationContactsAppInsideCall, ApplicationContactsApp )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationContactsAppInsideCall )
...
#endif /* _ApplicationContactsAppInsideCall_H */
