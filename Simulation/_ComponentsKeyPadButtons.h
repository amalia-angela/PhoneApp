...
#ifndef _ComponentsKeyPadButtons_H
#define _ComponentsKeyPadButtons_H
...
/* Forward declaration of the class Components::KeyPadButtons */
#ifndef _ComponentsKeyPadButtons_
  EW_DECLARE_CLASS( ComponentsKeyPadButtons )
#define _ComponentsKeyPadButtons_
#endif
...
EW_DEFINE_FIELDS( ComponentsKeyPadButtons, TemplatesPushButton )
...
EW_END_OF_FIELDS( ComponentsKeyPadButtons )

/* Virtual Method Table (VMT) for the class : 'Components::KeyPadButtons' */
EW_DEFINE_METHODS( ComponentsKeyPadButtons, TemplatesPushButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ComponentsKeyPadButtons _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsKeyPadButtons )
...
#endif /* _ComponentsKeyPadButtons_H */
