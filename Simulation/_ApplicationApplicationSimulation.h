...
#ifndef _ApplicationApplicationSimulation_H
#define _ApplicationApplicationSimulation_H
...
/* Deklaration of class variant : 'Application::ApplicationSimulation' */
EW_DEFINE_VFIELDS( ApplicationApplicationSimulation, XObject, ApplicationApplication )
  EW_OBJECT  ( PushButton,      WidgetSetPushButton )
EW_END_OF_VFIELDS( ApplicationApplicationSimulation )

/* Virtual Method Table (VMT) for the class variant : 'Application::ApplicationSimulation' */
EW_DEFINE_VMETHODS( ApplicationApplicationSimulation, XObject, ApplicationApplication )
EW_END_OF_VMETHODS( ApplicationApplicationSimulation )
...
#endif /* _ApplicationApplicationSimulation_H */
