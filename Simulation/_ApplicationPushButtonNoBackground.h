...
#ifndef _ApplicationPushButtonNoBackground_H
#define _ApplicationPushButtonNoBackground_H
...
/* Forward declaration of the class Application::PushButtonNoBackground */
#ifndef _ApplicationPushButtonNoBackground_
  EW_DECLARE_CLASS( ApplicationPushButtonNoBackground )
#define _ApplicationPushButtonNoBackground_
#endif
...
EW_DEFINE_FIELDS( ApplicationPushButtonNoBackground, TemplatesPushButton )
...
EW_END_OF_FIELDS( ApplicationPushButtonNoBackground )

/* Virtual Method Table (VMT) for the class : 'Application::PushButtonNoBackground' */
EW_DEFINE_METHODS( ApplicationPushButtonNoBackground, TemplatesPushButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ApplicationPushButtonNoBackground _this, 
    XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationPushButtonNoBackground )
...
#endif /* _ApplicationPushButtonNoBackground_H */
