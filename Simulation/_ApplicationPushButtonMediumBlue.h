...
#ifndef _ApplicationPushButtonMediumBlue_H
#define _ApplicationPushButtonMediumBlue_H
...
/* Forward declaration of the class Application::PushButtonMediumBlue */
#ifndef _ApplicationPushButtonMediumBlue_
  EW_DECLARE_CLASS( ApplicationPushButtonMediumBlue )
#define _ApplicationPushButtonMediumBlue_
#endif
...
EW_DEFINE_FIELDS( ApplicationPushButtonMediumBlue, TemplatesPushButton )
...
EW_DEFINE_METHODS( ApplicationPushButtonMediumBlue, TemplatesPushButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ApplicationPushButtonMediumBlue _this, XSet 
    aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationPushButtonMediumBlue )
...
#endif /* _ApplicationPushButtonMediumBlue_H */
