...
#ifndef _ComponentsNavBarButtons_H
#define _ComponentsNavBarButtons_H
...
/* Forward declaration of the class Components::NavBarButtons */
#ifndef _ComponentsNavBarButtons_
  EW_DECLARE_CLASS( ComponentsNavBarButtons )
#define _ComponentsNavBarButtons_
#endif
...
EW_DEFINE_FIELDS( ComponentsNavBarButtons, TemplatesPushButton )
...
EW_END_OF_FIELDS( ComponentsNavBarButtons )

/* Virtual Method Table (VMT) for the class : 'Components::NavBarButtons' */
EW_DEFINE_METHODS( ComponentsNavBarButtons, TemplatesPushButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ComponentsNavBarButtons _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsNavBarButtons )
...
#endif /* _ComponentsNavBarButtons_H */
