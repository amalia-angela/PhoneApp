...
#ifndef _ApplicationPushButtonSmall_H
#define _ApplicationPushButtonSmall_H
...
/* Forward declaration of the class Application::PushButtonSmall */
#ifndef _ApplicationPushButtonSmall_
  EW_DECLARE_CLASS( ApplicationPushButtonSmall )
#define _ApplicationPushButtonSmall_
#endif
...
EW_END_OF_FIELDS( ApplicationPushButtonSmall )

/* Virtual Method Table (VMT) for the class : 'Application::PushButtonSmall' */
EW_DEFINE_METHODS( ApplicationPushButtonSmall, TemplatesPushButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ApplicationPushButtonSmall _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationPushButtonSmall )
...
#endif /* _ApplicationPushButtonSmall_H */
