...
#ifndef _ApplicationPushButtonDelete_H
#define _ApplicationPushButtonDelete_H
...
/* Forward declaration of the class Application::PushButtonDelete */
#ifndef _ApplicationPushButtonDelete_
  EW_DECLARE_CLASS( ApplicationPushButtonDelete )
#define _ApplicationPushButtonDelete_
#endif
...
EW_DEFINE_FIELDS( ApplicationPushButtonDelete, TemplatesPushButton )
...
EW_END_OF_FIELDS( ApplicationPushButtonDelete )

/* Virtual Method Table (VMT) for the class : 'Application::PushButtonDelete' */
EW_DEFINE_METHODS( ApplicationPushButtonDelete, TemplatesPushButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ApplicationPushButtonDelete _this, XSet 
    aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationPushButtonDelete )
...
#endif /* _ApplicationPushButtonDelete_H */
