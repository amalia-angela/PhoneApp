...
#ifndef _ApplicationKeyPadButtons_H
#define _ApplicationKeyPadButtons_H
...
/* Forward declaration of the class Application::KeyPadButtons */
#ifndef _ApplicationKeyPadButtons_
  EW_DECLARE_CLASS( ApplicationKeyPadButtons )
#define _ApplicationKeyPadButtons_
#endif
...
EW_END_OF_FIELDS( ApplicationKeyPadButtons )

/* Virtual Method Table (VMT) for the class : 'Application::KeyPadButtons' */
EW_DEFINE_METHODS( ApplicationKeyPadButtons, TemplatesPushButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ApplicationKeyPadButtons _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationKeyPadButtons )
...
#endif /* _ApplicationKeyPadButtons_H */
