...
#ifndef _ComponentsPushButtonMediumBlue_H
#define _ComponentsPushButtonMediumBlue_H
...
/* Forward declaration of the class Components::PushButtonMediumBlue */
#ifndef _ComponentsPushButtonMediumBlue_
  EW_DECLARE_CLASS( ComponentsPushButtonMediumBlue )
#define _ComponentsPushButtonMediumBlue_
#endif
...
EW_DEFINE_FIELDS( ComponentsPushButtonMediumBlue, TemplatesPushButton )
...
EW_END_OF_FIELDS( ComponentsPushButtonMediumBlue )

/* Virtual Method Table (VMT) for the class : 'Components::PushButtonMediumBlue' */
EW_DEFINE_METHODS( ComponentsPushButtonMediumBlue, TemplatesPushButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ComponentsPushButtonMediumBlue _this, XSet 
    aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsPushButtonMediumBlue )
...
#endif /* _ComponentsPushButtonMediumBlue_H */
