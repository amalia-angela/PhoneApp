...
#ifndef _ApplicationPushButtonMediumRed_H
#define _ApplicationPushButtonMediumRed_H
...
/* Forward declaration of the class Application::PushButtonMediumRed */
#ifndef _ApplicationPushButtonMediumRed_
  EW_DECLARE_CLASS( ApplicationPushButtonMediumRed )
#define _ApplicationPushButtonMediumRed_
#endif
...
EW_DEFINE_FIELDS( ApplicationPushButtonMediumRed, TemplatesPushButton )
...
EW_END_OF_FIELDS( ApplicationPushButtonMediumRed )

/* Virtual Method Table (VMT) for the class : 'Application::PushButtonMediumRed' */
EW_DEFINE_METHODS( ApplicationPushButtonMediumRed, TemplatesPushButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ApplicationPushButtonMediumRed _this, XSet 
    aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationPushButtonMediumRed )
...
#endif /* _ApplicationPushButtonMediumRed_H */
