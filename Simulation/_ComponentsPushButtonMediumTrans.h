...
#ifndef _ComponentsPushButtonMediumTrans_H
#define _ComponentsPushButtonMediumTrans_H
...
/* Forward declaration of the class Components::PushButtonMediumTrans */
#ifndef _ComponentsPushButtonMediumTrans_
  EW_DECLARE_CLASS( ComponentsPushButtonMediumTrans )
#define _ComponentsPushButtonMediumTrans_
#endif
...
EW_DEFINE_FIELDS( ComponentsPushButtonMediumTrans, TemplatesPushButton )
...
EW_END_OF_FIELDS( ComponentsPushButtonMediumTrans )

/* Virtual Method Table (VMT) for the class : 'Components::PushButtonMediumTrans' */
EW_DEFINE_METHODS( ComponentsPushButtonMediumTrans, TemplatesPushButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ComponentsPushButtonMediumTrans _this, XSet 
    aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsPushButtonMediumTrans )
...
#endif /* _ComponentsPushButtonMediumTrans_H */
