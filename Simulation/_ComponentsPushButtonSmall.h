...
#ifndef _ComponentsPushButtonSmall_H
#define _ComponentsPushButtonSmall_H
...
/* Forward declaration of the class Components::PushButtonSmall */
#ifndef _ComponentsPushButtonSmall_
  EW_DECLARE_CLASS( ComponentsPushButtonSmall )
#define _ComponentsPushButtonSmall_
#endif
...
EW_DEFINE_FIELDS( ComponentsPushButtonSmall, TemplatesPushButton )
...
EW_END_OF_FIELDS( ComponentsPushButtonSmall )

/* Virtual Method Table (VMT) for the class : 'Components::PushButtonSmall' */
EW_DEFINE_METHODS( ComponentsPushButtonSmall, TemplatesPushButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( ComponentsPushButtonSmall _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsPushButtonSmall )
...
#endif /* _ComponentsPushButtonSmall_H */
